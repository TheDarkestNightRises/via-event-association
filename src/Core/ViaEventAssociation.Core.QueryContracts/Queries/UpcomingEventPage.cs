...
public abstract class UpcomingEventPage
{
    ...
    public record EventOverview(string Title, string Description, string Start, string End, string Visibility, int MaxCapacity, int NumberOfParticipants);
}