...
public class GuestAcceptsInvitationCommandHandlerTests
{
    ...
    public GuestAcceptsInvitationCommandHandlerTests(ITestOutputHelper testOutputHelper)
    {
    ...
    {
        // Arrange
        var command = GuestAcceptsInvitationCommand.Create(_eventId.ToString(), _guestId.ToString()).PayLoad;
        ...
        var handler = new GuestAcceptsInvitationCommandHandler(_repositoryMock, _guestRepositoryMock, _uowMock);
